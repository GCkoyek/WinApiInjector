...
#define HELPMARKER(str) ImGui::SameLine(); ImGui::TextColored(ImColor(44, 44, 0, 124), "(?)"); if (ImGui::IsItemHovered()) ImGui::SetTooltip(str)
...
void Menu::Style(void)
{
	...
	Colors[ImGuiCol_WindowBg] = ImVec4(ImColor(255, 255, 255, 255));
	Colors[ImGuiCol_ChildBg] = ImVec4(ImColor(255, 255, 255, 175));
	Colors[ImGuiCol_Text] = ImVec4(ImColor(0, 204, 204, 255)); //LOGO Kolor
	Colors[ImGuiCol_Separator] = ImVec4(ImColor(255, 255, 255, 135));
	Colors[ImGuiCol_CheckMark] = ImVec4(ImColor(2, 106, 191, 175));
	Colors[ImGuiCol_PopupBg] = ImVec4(ImColor(255, 255, 255, 175));
    ...
    Colors[ImGuiCol_FrameBg] = ImVec4(ImColor(255, 255, 255, 255));
    ...
    Colors[ImGuiCol_TabActive] = ImLerp(Colors[ImGuiCol_HeaderActive], Colors[ImGuiCol_TitleBgActive], 0.06f);
    Colors[ImGuiCol_TabUnfocused] = ImLerp(Colors[ImGuiCol_Tab], Colors[ImGuiCol_TitleBg], 0.80f);
    Colors[ImGuiCol_TabUnfocusedActive] = ImLerp(Colors[ImGuiCol_TabActive], Colors[ImGuiCol_TitleBg], 0.40f);
    Colors[ImGuiCol_PlotLines] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
    Colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.271f, 0.914f, 0.941f, 1.00f);
...
void Menu::Drawing(void)
{
    ...
    if (ImGui::Begin("MENU", nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar))
    {
        ...
        if (Menu::Tab == 0)
        {
            ...
            {
                ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(ImColor(255, 0, 0, 200)));
        ...
        ImGui::BeginChild("##TwoBar", ImVec2(ImGui::GetContentRegionAvail().x - 15, ImGui::GetContentRegionAvail().y - 15), true, ImGuiWindowFlags_NoScrollbar);
        {
            ...
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 9.5f);
                ImGui::SliderInt("Ammount od ammo :", &Settings::Weapon::AmmoToSet, 1, 999, nullptr, ImGuiSliderFlags_AlwaysClamp || ImGuiSliderFlags_NoInput);
            ImGui::Separator();
        }
        ImGui::EndChild();
        }
        ...
        ImGui::BeginChild("##MainBar", ImVec2(ImGui::GetContentRegionAvail().x / 2.f - 15, ImGui::GetContentRegionAvail().y - 15), true, ImGuiWindowFlags_NoScrollbar);
        {
            ...
            ImGui::PushFont(littleFont);
           ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 6.5f);
            ImGui::Checkbox("tpped", &Settings::Visuals::tpped);
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 2.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::Checkbox("invisible", &Settings::Visuals::invisibleped);
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 2.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::Checkbox("killped", &Settings::Visuals::killped);
            ...
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 4.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::Text("Made by lucyfer8431");
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 4.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 4.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::Text("You have full version of cheat");
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 4.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 4.5f);
            ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 10);
            ImGui::Text("Click to join my discord");
            if (ImGui::IsItemClicked())ShellExecute(0, 0, "https://discord.gg/3YxyhsbfVb", 0, 0, SW_SHOW);;
